...
public partial class DebugPathfinder : Node2D
{
	...
	private void TestPathfinder()
	{
        ...
        {
            Vector2I.Zero, new Vector2I(0, 1), new Vector2I(0, 2), new Vector2I(0, 3),
		...
		{
			Vector2I.Zero, new Vector2I(1, 0), new Vector2I(1, 1), new Vector2I(1, 2),
			new Vector2I(2, 2), new Vector2I(2, 3), new Vector2I(3, 3)
		};
